...
namespace ComiqueriaLogic
{
    ...
    public sealed class Venta
    {
        ...
        public static int PorcentajeIva
        {
            ...
            set
            {
                Venta.PorcentajeIva = PorcentajeIva1;
            }
        }
        ...
        public static int PorcentajeIva1 { get => porcentajeIva; set => porcentajeIva = value; }
        ...
        public static double CalcularPrecioFinal(double precioUnidad, int cantidad)
        {
            ...
            return precioSinIva + precioSinIva * Venta.PorcentajeIva1 / 100;
        }
