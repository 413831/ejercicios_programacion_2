...
namespace Ejercicio_36
{
    ...
    public class Competencia<T> where T : VehiculoCarrera
    {
        ...
        public static bool operator -(Competencia<T> competencia, T vehiculo)
        {
        ...
        {   
            ...
            {
                throw new CompetenciaNoDisponibleException("Competencia incorrecta", typeof(Competencia<T>).ToString(), "Operador +", exception);
            }
            return false;
        }
        ...
        public static bool operator ==(Competencia<T> competencia, T vehiculo)
        {
            ...
            {
                throw new CompetenciaNoDisponibleException("El vehiculo no corresponde a la competencia", typeof(Competencia<T>).ToString(), "Operador ==");
            }
            return returnValue;
        }
        public static bool operator !=(Competencia<T> competencia, T vehiculo)
