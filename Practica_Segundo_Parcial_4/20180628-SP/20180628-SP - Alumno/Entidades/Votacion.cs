...
namespace Entidades
{
    ...
    public class Votacion
    {
        ...
        public short ContadorAfirmativo { get => this.contadorAfirmativo; set => this.contadorAfirmativo = value; }
        public short ContadorNegativo { get => this.contadorNegativo; set => this.contadorNegativo = value; }
        public short ContadorAbstencion { get => this.contadorAbstencion; set => this.contadorAbstencion = value; }
        private Dictionary<string, EVoto> Senadores { get => this.senadores; set => this.senadores = value; }
        public string NombreLey { get => this.nombreLey; set => this.nombreLey = value; }
